        ...
        <div className=" md:w-1/3 max-w-sm">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="space-y-2">
              <button
                type="button"
                className="flex space-x-6 h-10 w-full mx-auto rounded-base bg-black hover:bg-zinc-600 text-white "
              >
              ...
              <button
                type="button"
                className="flex space-x-6 h-10 w-full mx-auto rounded-base bg-black text-white "
              >
                <div className="mx-auto flex py-2 space-x-2">
